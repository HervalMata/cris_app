...
import 'package:cris_app/features/personalization/controllers/update_name_controller.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Use seu nome real para fácil verificação. Este nome aparecerá em muitas páginas.',
